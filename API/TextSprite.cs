...
public class TextSprite : IDisposable
{
    ...
    public TextSprite(Texture2D texture, float positionX, float positionY)
    {
        SetTexture(texture);
    ...
    /// Construct from Texture2D
    public TextSprite(Texture2D texture, float positionX, float positionY, float degree, float scale)
    {
        SetTexture(texture);
    ...
    /// Construct from text
    public TextSprite(string text, uint argb, Font font, int positionX, int positionY)
    {

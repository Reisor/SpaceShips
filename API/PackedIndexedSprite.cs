...
/// <summary>POSITIONとUVをパック & index</summary>
	public class PackedIndexedSprite
	{
			...
			)
		{
			...
			float[] colors = spriteB.Colors;
			
			spritePrim.V0.Color = new UByte4N(colors[0],colors[1],colors[2],colors[3]);//_color;
			spritePrim.V1.Color = new UByte4N(colors[4],colors[5],colors[6],colors[7]);//_color;
			spritePrim.V2.Color = new UByte4N(colors[8],colors[9],colors[10],colors[11]);//_color;
			spritePrim.V3.Color = new UByte4N(colors[12],colors[13],colors[14],colors[15]);//_color;
		...
		{
			string resourceName = "API.shaders.PackedSprite.cgx";
